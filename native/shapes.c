...
/*void initWindowSizeinitWindowSize(int x, int y, unsigned int w, unsigned int h) {
	init_x = x;
	init_y = y;
	init_w = w;
	init_h = h;
...
void init(int *w, int *h) {
	...
	*w = p_state->window_width;
	*h = p_state->window_height;*/
}
